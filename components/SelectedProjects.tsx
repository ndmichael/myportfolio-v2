...
export default function SelectedProjects() {
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <Link
                href="/projects"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-lg hover:shadow-xl transition-transform hover:scale-105"
            >
                View All Projects
            </Link>
            </div>
